...
def configure_rnode(socket):
    ...
    time.sleep(0.2)
    # 4. Radio ON Ã¢â‚¬â€ starts RX immediately
            ...
            if byte == KISS_FEND:
                if self._in_frame and len(self._kiss_buf) > 1:
                    ...
                    if len(pkt) > 0:
                        ...
                        if port == CMD_DATA:
                            try:
                                RNS.log(f"PKT type=0x{pkt[0]:02x} len={len(pkt)} dest={pkt[2:18].hex() if len(pkt)>18 else None}")
...
def message_received(message):
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ Regular text message Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    text = ""
    try:
...
def _msgpack_decode_first(data):
    """
    Pure-Python minimal msgpack decoder Ã¢â‚¬â€ no external library needed.
...
def _decode_lxmf_app_data(app_data):
    ...
    Uses pure Python decoder Ã¢â‚¬â€ no external library required.
...
class RawAnnounceHandler:
    """Catches ALL announces regardless of aspect Ã¢â‚¬â€ for debugging"""
    aspect_filter = None
...
def _startup_announce_loop():
    ...
    Schedule:
      +15s  Ã¢â‚¬â€ catch phones that were slow to connect
      +60s  Ã¢â‚¬â€ catch phones that connected after initial announce
    ...
    try:
        ...
        try:
            for dest_hash, dest_obj in lxmf_router.delivery_destinations.items():
                ...
                dest_obj.set_proof_strategy(RNS.Destination.PROVE_ALL)
                RNS.log(f"Link callback+proof set on {RNS.prettyhexrep(dest_hash)}")
        except Exception as e:
...
def send_message(dest_hash_hex, text):
    ...
    try:
        # Normalise Ã¢â‚¬â€ always plain hex, no brackets
        dest_hash_hex = dest_hash_hex.strip().strip("<>")
        dest_hash = bytes.fromhex(dest_hash_hex)
        RNS.log(f"Sending to {dest_hash_hex}: {text}")

        # Get identity Ã¢â‚¬â€ cache first, then RNS recall
        with _data_lock:
        ...
        # Verify hash matches Ã¢â‚¬â€ if not, the identity is wrong
        ...
        # Request path before sending Ã¢â‚¬â€ helps on LoRa single-hop
...
# Ã¢â€â‚¬Ã¢â€â‚¬ Contacts Ã¢â‚¬â€ thin delegation to contacts.py Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
# Ã¢â€â‚¬Ã¢â€â‚¬ RNode config Ã¢â‚¬â€ bridge functions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
